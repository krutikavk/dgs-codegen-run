...
public class Show {
  ...
  public static tester.generated.types.Show.Builder newBuilder() {
    return new Builder();
  }
  ...
  public static class Builder {
    ...
    public Show build() {
      tester.generated.types.Show result = new tester.generated.types.Show();
      result.id = this.id;
    ...
    public tester.generated.types.Show.Builder id(String id) {
      this.id = id;
      setField(Field.ID);
      return this;
    }

    public tester.generated.types.Show.Builder title(String title) {
      this.title = title;
      setField(Field.TITLE);
      return this;
    }

    public tester.generated.types.Show.Builder releaseYear(Integer releaseYear) {
      this.releaseYear = releaseYear;
      setField(Field.RELEASEYEAR);
      return this;
    }
